...
```{r angle-regression-sim, fig.width = 6, cache = TRUE, fig.cap = 'The average MSE over 50 simulations in scenario 1. The errorbars are the standard error.'}
...
```{r theta-mse, fig.width = 6, cache = TRUE, fig.cap = 'The average MSE of the estimated angles in scenario 1 over 50 simulations. The errorbars are the standard error.'}
angle.reg.df %>% 
  dplyr::group_by(n) %>% 
...
```{r beta-regression-sim, fig.width = 6, cache = TRUE, fig.cap = 'The average MSE over 50 simulations in scenario 2. The errorbars are the standard error.'}
...
```{r beta-mse, fig.width = 6, cache = TRUE, fig.cap = 'The average MSE of the estimated beta parameters, $(a, b)$, in scenario 2 over 50 simulations. The errorbars are the standard error.'}
beta.reg.df %>% 
  dplyr::group_by(n) %>% 
