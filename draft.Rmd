...
\end{aligned}
$$
Since $\|T b - \hat{T} \hat{b} W\|_{2,\infty} \stackrel{p}{to} 0$, $\|T - \hat{T}\|_{2,\infty} \|b\|_F + \|\hat{T}\|_{2,\infty} \|b - \hat{b} W\|_F \stackrel{p}{\to} 0$. 
Then since $\|b\|_F$ and $\|\hat{T}\|_{2,\infty}$ are finite, both $\|T - \hat{T}\|_{2,\infty}$ and $\|b - \hat{b} W\|_F$ must converge to $0$ in probability. 
\end{proof}
